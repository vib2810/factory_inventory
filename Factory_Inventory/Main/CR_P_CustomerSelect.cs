...
namespace Factory_Inventory.Main
{
    public partial class CR_P_CustomerSelect : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "SELECT temp.Date_Of_Sale as 'Date of Sale', temp.Sale_DO_No as 'DO Number', T_M_Quality_Before_Job.Quality_Before_Job as Quality, temp.Sale_Rate as Rate, temp.Total_Amount as 'Total Amount', temp.Pending_Amount as 'Pending Amount', temp.Fiscal_Year\n";
                sql += "FROM\n";
