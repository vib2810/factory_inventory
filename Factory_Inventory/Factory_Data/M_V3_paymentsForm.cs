...
namespace Factory_Inventory.Factory_Data
{
    public partial class M_V3_paymentsForm : Form
    {
        ...
        private int loadData()
        {
            ...
            dt = c.runQuery("SELECT Voucher_ID, Sale_DO_No, Sale_Rate, Fiscal_Year, Net_Weight, Date_Of_Sale FROM Sales_Voucher WHERE DO_Payment_Closed = 0 AND Customer = '" + this.customerCB.SelectedItem.ToString() + "'");
