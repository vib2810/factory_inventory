...
{
    public partial class M_V3_cartonSalesForm : Form
    {
        ...
        public M_V3_cartonSalesForm(DataRow row, bool isEditable, M_V_history v1_history)
        {
            InitializeComponent();
            this.edit_form = true;
